...
class Model:
    ...
    def predict(self, model_input: Dict[str, Any], params: Optional[dict] = None) -> pd.DataFrame:
        """
        ...
        try:
            ...
            logger.info(f"Successfully generated forecast for {city} with {steps} steps")
            return forecast_final
