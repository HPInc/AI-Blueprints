...
class Logger:
    ...
    This class provides the log_model functionality for packaging Super Resolution
    models with FSRCNN neural network capabilities.
    """
    ...
    def log_model(
        ...
        /artifacts/
          └── data/                    # MLflow automatically created
              ...
              ├── demo/                # UI components  
              └── fsrcnn_model         # PyTorch model file
        ...
        Args:
            ...
            model_path: Path to the PyTorch model file (optional)
        ...
        try:
            ...
            # ✅ Handle PyTorch model file -> /artifacts/data/fsrcnn_model
            if model_path and os.path.exists(model_path):
                # Copy model file directly to temp directory with a standard name
                shutil.copy2(model_path, os.path.join(temp_dir, "fsrcnn_model"))
                logger.info(f"Copied PyTorch model file: {model_path}")
            else:
