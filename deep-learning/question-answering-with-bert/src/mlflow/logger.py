...
class Logger:
    ...
    def log_model(
        ...
        try:
            logger.info(f"Organizing BERT QA model artifacts in temp directory: {temp_dir}")
            ...
            if source_trainer is not None:
                ...
                logger.info("No trainer or pipeline provided - will use default model checkpoint")
            ...
            logger.info("BERT QA model logged successfully using models-from-code approach")
