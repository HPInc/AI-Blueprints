...
class Model:
    ...
    def __init__(self, model_checkpoint: str = "distilbert-base-cased", config: dict = None):
        """
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            logger.info(f"Question-answering pipeline loaded successfully with model: {self.model_checkpoint}")
        except Exception as e:
    ...
    def predict(self, model_input: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.model is None:
                raise ValueError("Model not loaded. Please ensure initialization was successful.")
