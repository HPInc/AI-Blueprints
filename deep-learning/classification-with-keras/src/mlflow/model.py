...
class Model:
            ...
            if self.model_path and os.path.exists(self.model_path):
                ...
                if not model_file_path:
                    ...
                    for filename in possible_filenames:
                        ...
                        if os.path.exists(potential_path):
                            model_file_path = potential_path
                            logger.info(f"Found model file in artifacts root: {model_file_path}")
                            break
    ...
    def predict(self, model_input: Union[pd.DataFrame, List, str], params: Optional[Dict[str, Any]] = None) -> List[int]:
        """
