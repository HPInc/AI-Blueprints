...
class FineTuningService:
    ...
    def log_model(
        ...
        try:
            ...
            cls._handle_model_artifact(finetuned_model_path, ft_artifact_dir, "fine-tuned")
            ...
            logger.info(f"Model logged successfully with artifact path: {artifact_path}")
    ...
    def _handle_model_artifact(model_path: str, artifact_dir: str, model_type: str):
        ...
        if model_path_obj.exists() and model_path_obj.is_dir():
            ...
            shutil.copy2(model_path, os.path.join(artifact_dir, os.path.basename(model_path)))
    ...
    def register_model(
        ...
        def resolve_model_path(path_str: str) -> str:
            ...
            from src.utils import get_project_root, get_models_dir, get_fine_tuned_models_dir
        ...
        with mlflow.start_run(run_name=run_name) as run:
            ...
            logger.info("✅ Fine-tuning comparison model registered as `%s` (run %s)", registry_name, run.info.run_id)
