...
class SummarizationService:
    ...
    def log_model(
        ...
        **kwargs,
        ...
        try:
            ...
            input_schema = Schema([ColSpec("string", "text", "array")])
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if model_path and os.path.exists(model_path):
                    ...
                    if os.path.isfile(model_path):
                        ...
                        model_dest = os.path.join(
                            model_dest_dir, os.path.basename(model_path)
                        )
                ...
                if "pip_requirements" in kwargs:
                    ...
                    requirements_path = os.path.join(
                        os.path.dirname(config_path), "..", "requirements.txt"
                    )
                ...
                logger.info(
                    "Model successfully logged to MLflow using models-from-code approach"
                )
    ...
    def predict(self, model_input: Dict[str, Any]) -> pd.DataFrame:
        ...
        if not self.model:
            raise RuntimeError(
                "No model instance available. Use log_model for MLflow registration."
            )
