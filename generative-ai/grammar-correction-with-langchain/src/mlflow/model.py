...
from src.llm_metrics import (
    semantic_similarity_eval_fn,
    readability_improvement_eval_fn,
    llm_judge_eval_fn_local,
)
...
class Model:
    ...
    def predict(
        ...
        for _, row in model_input.iterrows():
            ...
            placeholder_map, parsed_content = parse_md_for_grammar_correction(
                markdown_content
            )
            ...
            try:
                semantic_sim = semantic_similarity_eval_fn(
                    [corrected_content], [markdown_content]
                )
                readability = readability_improvement_eval_fn(
                    [corrected_content], [markdown_content]
                )
