        ...
        try:
            ...
            if local_model_dir and os.path.exists(local_model_dir):
                ...
                if os.path.isfile(local_model_dir):
                    ...
                    shutil.copy2(local_model_dir, os.path.join(local_temp_dir, os.path.basename(local_model_dir)))
                    logger.info(f"Copied local model file: {os.path.basename(local_model_dir)}")
                else:
            ...
            if e5_model_dir and os.path.exists(e5_model_dir):
                ...
                raise FileNotFoundError(f"E5 model directory not found at: {e5_model_dir}")
            ...
            if siglip_model_dir and os.path.exists(siglip_model_dir):
                ...
                raise FileNotFoundError(f"SigLIP model directory not found at: {siglip_model_dir}")
