"""
Base service class for AI Studio GenAI Templates.
This module provides the core functionality for all service classes,
including model loading, configuration, and LangChain integration.
"""
...
class BaseGenerativeService(PythonModel):
    """Base class for all generative services in AI Studio GenAI Templates."""
        ...
        try:
            ...
            if "proxy" in self.model_config and self.model_config["proxy"]:
                ...
                if system_proxy:
                    ...
                    logger.info("No proxy configuration found in config or environment variables.")
