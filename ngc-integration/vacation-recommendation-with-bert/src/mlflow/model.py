...
class Model:
    ...
    def __init__(
        ...
        try:
            ...
            raise RuntimeError(
                f"BERT Tourism Model initialization failed: {str(e)}"
            ) from e
    ...
    def _load_bert_artifacts(self) -> None:
        ...
        try:
            ...
            if self.model_path and os.path.exists(self.model_path):
                ...
                bert_model_path = self.model_config.get(
                    "model_path",
                    "/home/jovyan/datafabric/Bertlargeuncased/bertlargeuncased.nemo",
                )

            self.bert_model = BERTLMModel.restore_from(
                bert_model_path, strict=False
            ).to(self.device)
    ...
    def predict(
        self, model_input: Dict[str, Any], params: Dict[str, Any] = None
    ) -> List[Dict[str, Any]]:
        """
