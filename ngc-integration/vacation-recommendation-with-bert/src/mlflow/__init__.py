"""
MLflow models-from-code implementation for BERT Tourism Recommendation.

This module provides the standardized universal structure for MLflow model logging
and loading using the models-from-code approach for vacation recommendation with BERT.
"""
